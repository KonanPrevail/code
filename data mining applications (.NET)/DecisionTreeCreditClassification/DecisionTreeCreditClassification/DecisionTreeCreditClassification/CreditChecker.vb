...
Imports numl.Supervised.DecisionTree
Public Class CreditChecker
    ...
    Dim decisionTreeGenerator
    Dim decisionTreeModel
    ...
    Private Sub btnRun_Click(sender As Object, e As EventArgs) Handles btnRun.Click
        ...
        Dim iDecision = decisionTreeModel.Predict(oTestApplicant)
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        decisionTreeGenerator = New DecisionTreeGenerator(ApplicantDescriptor)
        LoadData("C:\Users\MC\Documents\gcredit.txt")
        decisionTreeModel = decisionTreeGenerator.Generate(TrainingData)
    End Sub
