...
# here the directory after home is your NetID xxxxxxxx
jobs = sc.textFile("file:///home//mcd04005//spark//data_sub.csv").map(lambda line: PATTERN.split(line)[1::2])
...
# or jobsfeaturesDF = sqlContext.createDataFrame(jobsfeatures)
